...
<img src="https://img.shields.io/badge/M.Sc.-Information%20Systems%20with%20Computing-6D28D9?style=for-the-badge&labelColor=111827"/>
<img src="https://img.shields.io/badge/B.Sc.-Computer%20Science-4C1D95?style=for-the-badge&labelColor=111827"/>
<img src="https://img.shields.io/badge/📍-Dublin%2C%20Ireland-312E81?style=for-the-badge&labelColor=111827"/>
...
<img src="https://komarev.com/ghpvc/?username=lohitsaun&label=PROFILE%20VIEWS&color=6D28D9&style=flat-square"/>
<img src="https://img.shields.io/github/followers/lohitsaun?label=FOLLOWERS&style=flat-square&color=4C1D95"/>
<img src="https://img.shields.io/github/stars/lohitsaun?label=STARS&style=flat-square&color=312E81"/>
...
`React` `TypeScript` `Redux Toolkit` `OAuth 2.0` `PKCE` `Spotify SDK`
...
<details>
<summary><strong>🖌️ Real-Time Collaborative Whiteboard</strong></summary>
...
<details>
<summary><strong>🤖 Employee Attendance Automation & Analytics</strong></summary>
...
`UiPath` `Python` `MySQL` `Node.js` `Power BI` `RPA` `AI/ML`
...
`UiPath` `RPA` `Python` `SQL` `Automation` `Data Analysis` `Agile` `Process Optimization`
